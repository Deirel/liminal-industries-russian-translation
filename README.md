...
Перевод квестов и названий предметов для двух вариантов модпака:
...
собирается отдельный клиентский Forge-мод с точным payload её книги квестов.

## Установка

1. Выберите JAR, соответствующий установленному модпаку.
2. Поместите его в каталог `mods` профиля.
...
Служебный runtime-аудит названий предметов находится отдельно в `audit-mod/`.
