...
2. JAR уже включает технические исправления книг целевой версии.
3. Для перевода только отдельных модов вместо JAR поместите нужные ZIP в
   каталог `resourcepacks` и включите их в меню Minecraft. В этом режиме
   технические исправления можно подключить отдельным compatibility ZIP.
...
Ресурсы JAR служат нижним автоматически включённым слоем. Обычные
пользовательские ресурс-паки могут переопределять его тексты.
