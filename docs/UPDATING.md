...
4. Установите клиентский пакет в чистый профиль. Проверьте русский язык,
   ресурс-пак, все главы квестов и названия предметов.
5. Установите серверный пакет на тестовый сервер. Подключитесь с клиентским
   пакетом. Откройте все главы и проверьте, что сервер отдаёт перевод.
